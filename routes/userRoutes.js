...
import { getUserProfile, login, register,logout,createProfile, updateProfile, getUserProfileInfo, toggleUserActiveStatus} from '../controllers/userController.js';
...
router.put('/toggle-active/:userId',isAuthenticate, toggleUserActiveStatus);
